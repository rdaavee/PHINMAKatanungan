...
<body class="custom-body">
    <div class="dashboard-pg bg-white">
    ...
    <div class="table-box">
        <section id="table-box" class="m-4">
                                        ...
                                        <div class="modal-dialog modal-style">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-proceed" onclick="confirmBan(this)" data-student-id="{{ $item->user_id }}">Confirm</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row g-3">
                                                    <form action="{{ url('students/'.$item->user_id.'/edit') }}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-md-4 mb-2">
                                                            ...
                                                            <input type="text" class="form-control" name="first_name" value="{{ $item->first_name }}" autocomplete="off" disabled>
                                                        </div>
                                                        <div class="col-md-4 mb-2">
                                                            <label for="" class="form-label">Middle Name</label>
                                                            <input type="text" class="form-control" name="middle_name" value="{{ $item->middle_name }}" autocomplete="off" disabled>
                                                        </div>
                                                        <div class="col-md-4 mb-2">
                                                            <label for="" class="form-label">Last Name</label>
                                                            <input type="text" class="form-control" name="last_name" value="{{ $item->last_name }}" autocomplete="off" disabled>
                                                        </div>
                                                        <div class="col-md-8 mb-2">
                                                            <label for="" class="form-label">Email</label>
                                                            <input type="text" class="form-control" name="email" value="{{ $item->email }}" autocomplete="off" disabled>
                                                        </div>
